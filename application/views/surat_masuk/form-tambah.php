	        ...
	        <div class="card">
	            <div class="card-header">
	                ...
	                <span class="float-right">
                       	<a href="<?=base_url()?>Surat_keluar/tampil/patrials" class="btn btn-warning btn-sm"><i class="fa fa-chevron-circle-left"></i></a>
	                </span>
	            </div>
	            <div class="card-body">
	            	<form method="post" id="tambah" method="POST" action="<?php echo base_url().'Surat_keluar/simpan'?>"  enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3 offset-2">
                            	<label for="lampiran" class=" form-control-label">Keterangan Surat</label>
                            </div>
                            <div class="col-12 col-md-4">
    ...
    $(document).ready(function(){
        ...
        $('#tambah').validate({
            ...
            submitHandler: function (form) {
               ...
               $.ajax({
                url: '<?=base_url()?>Surat_keluar/simpan/',
                data: data,
                type: 'POST',
