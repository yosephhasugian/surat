	        ...
	        <div class="card">
	            <div class="card-header">
	                ...
	                <span class="float-right">
                       	<a href="<?=base_url()?>paparan/tampil/patrials" class="btn btn-warning btn-sm"><i class="fa fa-chevron-circle-left"></i></a>
	                </span>
	            </div>
	            <div class="card-body">
	            	<form method="post" id="tambah" method="POST" action="<?php echo base_url().'Paparan/simpan'?>"  enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3 offset-2">
                            	<label for="berkas" class=" form-control-label">Uploads PPT</label>
                            </div>
                            <div class="col-12 col-md-4">
